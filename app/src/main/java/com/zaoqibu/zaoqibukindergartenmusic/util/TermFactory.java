...
public class TermFactory {
    ...
    public Term createTermWithNursery1() {
        Term term = new Term("小班·上", R.drawable.term_item_nursery34_selector, R.drawable.nursery34_1);
    ...
    public Term createTermWithNursery2() {
        Term term = new Term("小班·下", R.drawable.term_item_nursery34_selector, R.drawable.nursery34_2);
    ...
    public Term createTermWithLowerKindergarten1() {
        Term term = new Term("中班·上", R.drawable.term_item_lowerkindergarten45_selector, R.drawable.lowerkindergarten45_1);
    ...
    public Term createTermWithLowerKindergarten2() {
        Term term = new Term("中班·下", R.drawable.term_item_lowerkindergarten45_selector, R.drawable.lowerkindergarten45_2);
    ...
    public Term createTermWithUpperKindergarten1() {
        Term term = new Term("大班·上", R.drawable.term_item_upperkindergarten56_selector, R.drawable.upperkindergarten56_1);
    ...
    public Term createTermWithUpperKindergarten2() {
        Term term = new Term("大班·下", R.drawable.term_item_upperkindergarten56_selector, R.drawable.upperkindergarten56_2);
