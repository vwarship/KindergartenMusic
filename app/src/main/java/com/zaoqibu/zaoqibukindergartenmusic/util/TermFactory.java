...
public class TermFactory {
    ...
    public Term createTermWithNursery1() {
        Term term = new Term("小班·上", R.color.nursery_term_background_color, R.drawable.cabbage);
    ...
    public Term createTermWithNursery2() {
        Term term = new Term("小班·下", R.color.nursery_term_background_color, R.drawable.carrot);
    ...
    public Term createTermWithLowerKindergarten1() {
        Term term = new Term("中班·上", R.color.lower_kindergarten_term_background_color, R.drawable.corn);
    ...
    public Term createTermWithLowerKindergarten2() {
        Term term = new Term("中班·下", R.color.lower_kindergarten_term_background_color, R.drawable.lemon);
    ...
    public Term createTermWithUpperKindergarten1() {
        Term term = new Term("大班·上", R.color.upper_kindergarten_term_background_color, R.drawable.pumpkin);
    ...
    public Term createTermWithUpperKindergarten2() {
        Term term = new Term("大班·下", R.color.upper_kindergarten_term_background_color, R.drawable.tomato);
